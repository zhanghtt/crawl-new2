...
request = {"url": "https://wq.jd.com/commodity/comment/getcommentlist?callback=fetchJSON_comment98&pagesize=10&sceneval=2&skucomment=1&score=0&sku=10025622101075&sorttype=6&page=0",
           "headers": {
...
request1 = {"url": "https://wq.jd.com/commodity/comment/getcommentlist?callback=skuJDEvalB&version=v2&pagesize=10&sceneval=2&skucomment=1&score=0&sku=51963222491&sorttype=6&page=1&t=0.5156075450518778",
           "headers": {
               'Connection': 'keep-alive',
               'Host':'wq.jd.com',
               'accept':'*/*',
...
for i in range(10000):
    ...
    #src = requests.get(**request,proxies={"https": "https://u2:crawl@192.168.0.71:3128","http": "http://u2:crawl@192.168.0.71:3128"})
