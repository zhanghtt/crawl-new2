...
class FirstMaster(Master):
    def __init__(self, *args, **kwargs):
        ...
        self.out_table = "jdprice_miss_out".format(current_date)
    ...
    def init_start_urls(self):
        ...
        with op.DBManger() as m:
            ...
            skuid_set = set()
            for item in m.read_from(db_collect=("jingdong", "jdprice_miss_seed"), out_field=("skuid",), pipeline=pipeline):
